...
<html>
<head>
    <title>Admin Page Expositions <username:usernameTagHandler userId="${user.userId}" lang="${locale}"/></title>
            ...
            <c:when test="${showExpositions}">
                <table class="sort table" align="center">
                    ...
                    <tr>
                        ...
                        <fmt:message bundle="${local}" var="table_header_ticket_price"
                                     key="admin.table_header.ticket_price"/>
                        <fmt:message bundle="${local}" var="table_header_tickets_count"
                                     key="admin.table_header.tickets_count"/>
                    ...
                    <c:forEach items="${ requestScope.expositions}" var="exposition">
                        <tr>
                            ...
                            <td><c:out value="${exposition.theme }"/>
                                <form action="controller" method="get">
                                    ...
                                    <input class="btn btn-primary btn-xs" type="submit"
                                           value="${show_exposition_picture_label}">
                                </form>
                            </td>
                            ...
                            <td class="user-button button-td">
                                <form action="controller" method="get">
                                    <fmt:message bundle="${local}" key="admin.button_labels.show_statistic"
                                                 var="statistic_label"/>
                                    <fmt:message bundle="${local}" key="admin.button_labels.edit_exposition"
                                                 var="edit_exposition_label"/>
                                    <input type="hidden" name="exposition_id" value="${exposition.id}">
                                    <input type="hidden" name="command" value="showEditExposition">
                                    <input class="btn btn-primary btn-block" type="submit"
                                           value="${edit_exposition_label}">
                                </form>
                                    <%--</td>--%>
                                    <%--<td class="user-button button-td">--%>
                                <form action="controller" method="get">
                ...
                <form action="controller" method="get">
                    ...
                    <fmt:message bundle="${local}" key="admin.button_labels.create_exposition"
                                 var="create_exposition_label"/>
