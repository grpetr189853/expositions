                                ...
                                <div class="card-body">
                                    ...
                                    <div class="exposition-detail">
                                        <div class="ticket-price">
                                            ...
                                            <span class="ticket-price-value"><c:out value="${exposition.ticketPrice }" /></span>
                                        </div>
                                        <div class="tickets-count">
                                            <span class="tickets-count-header">${tickets_count}</span>
                                            <span class="tickets-count-value"><c:out value="${exposition.ticketsCount }" /></span>
                                        </div>
                                        <div class="date-in">
                                            <span class="date-in-header">${start_date}</span>
                                            <span class="date-in-value"><c:out value="${exposition.dateIn }" /></span>
                                        </div>
                                        <div class="date-out">
                                            <span class="date-out-header">${end_date}</span>
                                            <span class="date-out-value"><c:out value="${exposition.dateOut }" /></span>
                                        </div>
                                        <div class="halls">
                                            <span class="halls-header">${halls}</span>
                                            <span class="halls-value"><c:out value="${exposition.hallsNames }" /></span>
                                        </div>
                                    </div>
                                    <div class="test-tags">
